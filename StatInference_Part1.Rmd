...
round(mean(d2),2)
``` 
tends to equal the mean of standard normal distrubution, which is 0

Distribution St deviation ```{r echo=FALSE, message=FALSE}round(sd(d2),2) ``` tends to equal the St. Deviation of standard normal distrubution, which is 1
